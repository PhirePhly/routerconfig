...
if [ -a /etc/squid3/squid.conf ]; then
...
acl entirenet src $ENTIRESUBNET
acl securenet src $SECURESUBNET
...
http_access allow securenet manager
http_access deny manager
http_access allow entirenet
...
cache_dir ufs /home/proxy 30000 16 256
